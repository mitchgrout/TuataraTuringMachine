...
public class TM_State implements Serializable{
    ...
    public static final int STATE_RENDERING_WIDTH = 30; //width of the graphical representation
                    //of the state, in pixels.
    public static final int TEXT_DISTANCE = 15; //distance of graphical text below picture
                    //of the state.
    ...
    /** Adds an outgoing transition from this state.  It is best to use the TMachine
     *  object's methods to modify the machine, instead of calling this directly.
     */
    ...
    /** Removes an outgoing transition from this state.  It is best to use the TMachine
     *  object's methods to modify the machine, instead of calling this directly.
     */
    ...
    /** Removes all outgoing transition from this state.  Does not update the machine itself,
     *  so generally this is only useful to remove any transitions before adding a copy of
     *  a state to the machine.
     */
    ...
    public void paint(Graphics g, Collection<TM_State> selectedStates)
    {
        ...
        if (isStartState())
        {
            ...
            //tail
            g2d.draw(new QuadCurve2D.Float(m_windowX - STATE_RENDERING_WIDTH/2, m_windowY + STATE_RENDERING_WIDTH/2, m_windowX - STATE_RENDERING_WIDTH*3/4, m_windowY + STATE_RENDERING_WIDTH/2, m_windowX - STATE_RENDERING_WIDTH*2/3, m_windowY + STATE_RENDERING_WIDTH/3));
        }
